...
const music_list = [
    {
        cover: 'https://i.postimg.cc/yNcbVk22/IMG-20240207-WA0025.jpg', // Add the cover image URL
        name: 'MONTA RE',
...
function loadTrack(track_index) {
    ...
    if (currentTrack.cover) {
        ...
        image_cover.src = currentTrack.cover;
    } else {
        image_cover.style.display = 'none';
        video_player.style.display = 'block';
        video_player.src = currentTrack.video;
        video_player.load();
        video_player.play();
    ...
    audio_player.src = currentTrack.music;
    audio_player.load();
